<template>
    <f7-page class="no-toolbar">
        ...
        <f7-list form>
            <f7-list-item v-for="n in 3" key="key.id" checkbox name="my-checkbox" :value="n" :title="'Checkbox ' + n"></f7-list-item>
        </f7-list>
        <f7-block-title>Radios</f7-block-title>
        <f7-list form>
            <f7-list-item v-for="n in 3" key="key.id" radio name="my-radio" :checked="n === 1" :value="n" :title="'Radio ' + n"></f7-list-item>
        </f7-list>
