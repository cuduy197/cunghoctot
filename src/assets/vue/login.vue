        ...
        <f7-view>
            <f7-pages>
                <f7-page login-screen>
                    <f7-progressbar v-if="!singin" :progress="0" color="green"></f7-progressbar>
                    ...
                    <!--                     <div v-if="singin">
                        ...
                        <div v-if="!user.login">
                            <f7-list>
                                <f7-list-button>
                                    <f7-preloader color="green" size="114px"></f7-preloader>
                                </f7-list-button>
                            </f7-list>
                        </div>
                    </div> -->
                    <div v-if="!singin">
                        <f7-list form>
                            <f7-list-item>
                                ...
                                <f7-input v-model="email" name="username" placeholder="nhập email" type="email"></f7-input>
                            </f7-list-item>
                            <f7-list-item>
                        ...
                        <f7-list>
                            ...
                            <f7-list>
                                <f7-list-button v-if="Register">
                                    <f7-button big @click="Register=!Register" fill color="">Trở lại đăng nhập </f7-button>
                                </f7-list-button>
                            </f7-list>
                        </f7-list>
                        <div>
                            <f7-list>
                                <f7-grid>
                                    <f7-col>
                                        <f7-button big fill v-if="!Register" open-popup="#RECOVERY_PASS" color="pink">Quên mật khẩu</f7-button>
                                    </f7-col>
                                    <f7-col>
